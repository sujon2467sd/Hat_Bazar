...
class HomeController extends Controller
{
    ...
    public function search(Request $request){
        ...
        $products = Product::whereIn('id', $searchResults)->paginate(10);
    ...
    public function offer_product(){
        ...
        return view('frontend.shop.shop',[
            ...
            'categories' => Maincategory::get(),
            'products' => Product::where('discount_price','>=',15)->paginate(10),
        ]);
    }
    ...
    public function SerVice(){
        return view('frontend.service.service',[
            ...
            'journeys'=>Ourjourney::where('status','1')->get(),
            'video'=>Ourjourney::where('status','1')->latest()->first(),
