...
<body>
    <div class="invoice-box">
        <table>
            <tr class="top">
                <td colspan="2">
                    <table>
                        <tr>
                            <td class="title">
                                <img src="{{ ('admin/logo_images/'.$logo->logo_img) }}" style="width: 50%; max-width: 300px" />
                            </td>
            ...
            <tr class="item " >
                <td>{{ $item->product->name }} x {{ $item->product_qty }} -------------------- <img src="{{ ('product_images/'.$item->product->image_path) }}" alt="" width="40px"></td>
