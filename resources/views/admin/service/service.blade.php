            ...
            <tbody>
                 ...
                 @foreach ($services as $service)
                    <tr>
                        ...
                        <td><img src="{{ asset('admin/cate_images/'.$service->img) }}"  width="300px" alt=""></td>
                        <td>
                        @if($service->status==1)
                            <a href="{{ route('service.status',$service->id) }}" class="btn btn-success btn-sm"  onclick="return confirm('Are you Sure to Deactive')">Active</a>
                        @else
                            <a href="{{ route('service.status',$service->id) }}" class="btn btn-danger btn-sm"  onclick="return confirm('Are you Sure to Active')">DeActive</a>
                        @endif
                        </td>
