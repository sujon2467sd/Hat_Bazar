                            ...
                            <div class="col-lg-4">
                                <div class="ltn__tab-menu-list mb-50">
                                    <div class="nav">
                                        ...
                                        <a href="login.html" onclick="event.preventDefault(); document.getElementById('logoutForm').submit()">Logout <i class="fas fa-sign-out-alt" confirm></i></a>
                                        ...
                                        <div class="ltn__myaccount-tab-content-inner">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 col-12 learts-mb-30">
                                                    <h4>Billing Address <small></a></small></h4>
                                                    <address>
                                                        <p><strong>Alex Tuntuni</strong></p>
                                                        <p>{{ $top_menu->address }}</p>
                                                        <p>{{ $prf_infos->number}}</p>
                                                    </address>
                                                </div>
                                                <div class="col-md-6 col-12 learts-mb-30">
                                                    <h4>Shipping Address <small></small></h4>
                                                    <address>
