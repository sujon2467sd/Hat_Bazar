                                                 ...
                                                 <ul>
                                                    ...
                                                    <li>
                                                        <div class="cart-plus-minus">
                                                            <input type="number" value="1" min="1" max="5" name="qtybutton" class="cart-plus-minus-box">
                                                        </div>
                                                    </li>

                                                     <li>
                                                         <a href="#" class="theme-btn-1 btn btn-effect-1" title="Add to Cart" onclick="addToCart(event, {{ $product->id }})">
                                                             <i class="fas fa-shopping-cart"></i>
