                                            ...
                                            <div class="product-img">
                                                ...
                                                <div class="product-hover-action">
                                                    <ul>
                                                        ...
                                                        <li>
                                                            <a href="#" title="Add to Cart" onclick="addToCart(event, {{ $product->id }})">
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="row ltn__small-product-slider-active slick-arrow-1  slick-arrow-1-inner---">
                        ...
                        <div class="col-lg-4 col-md-6 col-12" data-aos="fade-right">
                            ...
                            <div class="ltn__small-product-item">
                                <div class="small-product-item-img">
                                    <a href="{{ route('product.details',$latest->id) }}"><img src="{{ asset('product_images/'.$latest->image_path) }}" alt="Image"></a>
                                </div>
                                <div class="small-product-item-info">
                                    <div class="product-ratting">
                                        <ul>
                                    ...
                                    <h2 class="product-title"><a href="{{ route('product.details',$latest->id) }}">{{  $latest->name }}</a></h2>
                                    <div class="product-price">
                    ...
                    <div class="row ltn__small-product-slider-active slick-arrow-1">
                      ...
                      <div class="col-lg-4 col-md-6 col-12" data-aos="fade-left">
                         @foreach ($chunk as  $best_sell)
                            <div class="ltn__small-product-item">
                                <div class="small-product-item-img">
                                    <a href="{{ route('product.details',$best_sell->id) }}"><img src="{{ asset('product_images/'.$best_sell->image_path) }}" alt="Image"></a>
                                </div>
                                <div class="small-product-item-info">
                                    <div class="product-ratting">
                                        <ul>
                                    ...
                                    <h2 class="product-title"><a href="{{ route('product.details',$best_sell->id) }}">{{  $best_sell->name }}</a></h2>
                                    <div class="product-price">
