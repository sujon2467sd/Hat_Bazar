...
Route::middleware(['auth','admin'])->group(function (){
    ...
    Route::resource('/our-journey', OurjourneyController::class);
    Route::get('/our-journey-status/{id}', [OurjourneyController::class, 'our_journey_status'])->name('our_journey.status');
});
...
Route::post('/cart-remove/{rowId}', [CartController::class, 'removeCart'])->name('cart.remove');
// cart route end
